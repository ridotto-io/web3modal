...
import { formatEther, JsonRpcProvider, InfuraProvider, getAddress as getOriginalAddress } from 'ethers';
import { EthersConstantsUtil, EthersHelpersUtil, EthersStoreUtil } from '@ridotto-io/w3-scaffold-utils/ethers';
...
export class Web3Modal extends Web3ModalScaffold {
    ...
    async setEmailProvider() {
        ...
        if (this.emailProvider) {
            ...
            if (address && chainId) {
                EthersStoreUtil.setChainId(chainId);
                EthersStoreUtil.setProviderType(ConstantsUtil.EMAIL_CONNECTOR_ID);
