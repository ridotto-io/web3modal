export type ColorType = 'accent-100' | 'error-100' | 'fg-100' | 'fg-200' | 'fg-250' | 'fg-300' | 'inherit' | 'inverse-000' | 'inverse-100' | 'success-100';
export type TextType = 'large-500' | 'large-600' | 'large-700' | 'micro-600' | 'micro-700' | 'paragraph-500' | 'paragraph-600' | 'paragraph-700' | 'small-400' | 'small-500' | 'small-600' | 'tiny-500' | 'tiny-600';
...
export type IconType = 'allWallets' | 'appStore' | 'chromeStore' | 'apple' | 'arrowBottom' | 'arrowLeft' | 'arrowRight' | 'arrowTop' | 'browser' | 'checkmark' | 'chevronBottom' | 'chevronLeft' | 'chevronRight' | 'chevronTop' | 'clock' | 'close' | 'coinPlaceholder' | 'compass' | 'copy' | 'cursor' | 'desktop' | 'disconnect' | 'discord' | 'etherscan' | 'extension' | 'externalLink' | 'facebook' | 'filters' | 'github' | 'google' | 'helpCircle' | 'infoCircle' | 'mail' | 'mobile' | 'networkPlaceholder' |  'profileImage' |'nftPlaceholder' | 'off' | 'playStore' | 'qrCode' | 'refresh' | 'search' | 'swapHorizontal' | 'swapVertical' | 'telegram' | 'twitch' | 'twitter' | 'twitterIcon' | 'wallet' | 'walletConnect' | 'walletPlaceholder' | 'warningCircle';
...
export type TransactionType = 'bought' | 'buy' | 'cryptoSent' | 'deposited' | 'minted' | 'nftSent' | 'received' | 'swapped' | 'withdrawed';
