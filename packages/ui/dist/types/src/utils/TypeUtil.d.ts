export type ColorType = 'accent-100' | 'error-100' | 'fg-100' | 'fg-200' | 'fg-250' | 'fg-300' | 'inherit' | 'inverse-000' | 'inverse-100' | 'success-100' | 'glass-005';
export type TextType = 'large-500' | 'large-600' | 'large-700' | 'micro-600' | 'micro-700' | 'paragraph-400' | 'paragraph-500' | 'paragraph-600' | 'paragraph-700' | 'small-400' | 'small-500' | 'small-600' | 'tiny-500' | 'tiny-600';
